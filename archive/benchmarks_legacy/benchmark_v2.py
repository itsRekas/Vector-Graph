...
def create_visualization(results: Dict[str, Dict], queries_info: List[Dict[str, str]] = None, output_file: str = "benchmark_results_v2.png"):
    """
    ...
    def create_single_plot(query_list, title_suffix, filename_suffix):
        ...
        ax.set_title(f'Query Results Comparison: Vector (k values) vs comunica-sparql-file - {title_suffix} (V2)', fontsize=14, fontweight='bold')
        ax.set_xticks(x)
...
def main():
    ...
    print("=" * 70)
    print("Comunica Benchmark Script - V2")
    print("V2: Second version")
    print("=" * 70)
    ...
    output_json = "benchmark_results_v2.json"
