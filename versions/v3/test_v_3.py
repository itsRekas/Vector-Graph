...
collection_name = "lubm_graph_v_3"

# Define collection schema with raw embedding field
# V3: Embedding dimension is 3x model dim (S|P|O concatenated), each part normalized separately
fields = [
...
schema = CollectionSchema(fields, "V3: Collection with S|P|O embeddings, each part normalized separately")
...
# V3: Parse into S, P, O, embed each separately, normalize each part, then concatenate
...
# V3: Search queries use normalized present parts and random unnormalized vectors for missing parts
